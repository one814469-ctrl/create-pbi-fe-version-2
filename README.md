...
1.  **Loan Application Portal (Customer-facing):** Allows customers to apply for loans online and track their application status.
2.  **Automated Document Verification:** Simulates document upload, OCR processing, and handling of verification outcomes.
3.  **Credit Check Integration:** Demonstrates mock integration with a Credit Bureau API to fetch and display credit scores for loan officers.

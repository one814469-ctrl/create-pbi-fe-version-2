...
This project uses **pure CSS** and standard HTML elements, without external UI libraries like Shadcn UI or Radix UI.
Custom styling is applied via CSS variables to implement the FinTrust brand theme.
...
It includes a left navigation and top bar suitable for enterprise applications.
...
*   **Application Status Tracking**: Displays mock application statuses using styled divs and badges.
...
*   **Notifications & Automated Reminders**: Mock notification triggers for applicants and employees, delivered via a custom, simple toast system.
...
*   `src/`: Application source code.
    ...
    *   `App.css`: Global styles, including custom FinTrust theme and utility classes.

...
export const mockLoanApplications = [
  ...
  },
  {
    ...
    customerID: 'CUST003', // Mock ID for demonstration
    type: 'Auto Loan',
    amount: 30000,
  ...
  },
  {
    ...
    customerID: 'CUST004', // Mock ID for demonstration
    type: 'Personal Loan',
    amount: 5000,
    status: 'Rejected',
...
export const mockReports = {
  ...
  turnaroundTime: {
    labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
    data: [7, 6, 5, 6, 4, 5] // days
  },
  csatScores: {
    labels: ['Q1', 'Q2', 'Q3', 'Q4'],
    data: [3.8, 4.1, 4.0, 4.2], // out of 5
    comments: [

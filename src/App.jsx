...
function App() {
  ...
  const displayMessage = (type, title, description) => {
    toast({
      ...
      // Custom classNames for info/success variants to align with brand theme
      className: cn(
        type === 'info' && 'border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-900 text-blue-800 dark:text-blue-200',
        type === 'success' && 'border-l-4 border-green-500 bg-green-50 dark:bg-green-900 text-green-800 dark:text-green-200'
      )
    });
  };
  ...
  return (
    <div className="flex min-h-screen flex-col bg-fintrust-bg text-foreground font-sans antialiased">

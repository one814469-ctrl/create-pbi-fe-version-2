...
const InternalDashboardPage = ({ epics }) => {
  ...
  const [mockApplications, setMockApplications] = useState([
    ...
    {
      id: 'APP-INTERNAL-REMINDERS', // Special ID for internal reminders state
      internalReminders: []
    }
  ]);
  ...
  const filteredApplications = mockApplications.filter(app =>
    app.id !== 'APP-INTERNAL-REMINDERS' && // Exclude internal reminders state from main list
            ...
            {getAuditTrailTask && (
              <div className="mt-4 p-4 border-dashed">
                ...
                <div className="mock-api-response">
                  ...
                  {/* Negative case "Given a user without dashboard permissions" handled by router in App.jsx */}
                </div>
              </div>
            )}
          </Card>

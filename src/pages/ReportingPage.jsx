    ...
    if (reportType === 'volume') {
      ...
      if (dataExists) {
        setCsatData({
          ...
          totalSurveys: Math.floor(Math.random() * 200) + 50,
          comments: [
      ...
      <div className="dashboard-grid">
        {volumeReportStory && (
          <Card>
            ...
            {reportData && reportData !== 'no-data' && reportType === 'volume' && (
              <div className="mock-api-response mt-4">
                ...
                <p className="success-message"><em>Acceptance Criteria: {getVolumeReportTask?.acceptance_criteria[0]} (Mocked)</em></p>
              </div>
            )}
            {csatData && csatData !== 'no-data' && reportType === 'csat' && (
              <div className="mock-api-response mt-4">
                ...
                <p className="success-message"><em>Acceptance Criteria: {getCsatTask?.acceptance_criteria[0]} (Mocked)</em></p>
              </div>
            )}
            {csatData === 'no-data' && reportType === 'csat' && (
              <p className="error-message mt-4">Insufficient survey data to generate report.

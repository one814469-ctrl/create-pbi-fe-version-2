...
const LoanApplicationForm = ({ onUpdateApplication }) => {
  ...
  return (
    <div className="loan-application-form">
      ...
      <p className="mt-4"><em>Acceptance Criteria: {task.acceptance_criteria[0]} (Mocked)</em></p>
      {Object.keys(errors).length > 0 && <p className="mt-2 error-message"><em>Edge Case: {task.acceptance_criteria[1]} (Mocked)</em></p>}
    </div>
  );
};

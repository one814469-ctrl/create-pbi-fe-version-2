  ...
  return (
    <nav className="navbar">
      ...
      <div className="navbar-nav">
        ...
        {/* Dynamic Epics menu (visible to all for traceability) */}
        {epics && epics.map(epic => {
          // Exclude epics that already have dedicated top-level routes
          if (['Loan Application Portal', 'Internal Loan Management Dashboard', 'Reporting & Analytics'].includes(epic.title)) {
            return null;
          }

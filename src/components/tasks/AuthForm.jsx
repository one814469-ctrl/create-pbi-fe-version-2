...
const AuthForm = ({ displayMessage }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!username || !password) {
      ...
      displayMessage('destructive', 'Login Failed', 'Please enter both username and password.');
      return;
    }
    ...
    try {
      ...
      displayMessage('destructive', 'Login Failed', error.message || 'Authentication failed. Please check your credentials.');
    }
  };
  ...
  if (isAuthenticated) {
    return (
      <Card className="w-full max-w-md mx-auto">
        ...
        <CardContent>
          <p className="text-green-600 dark:text-green-400 mb-4">You are currently logged in.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              required
              className={cn(errorMessage && 'error-border')}
            />
          </div>
          <div className="space-y-2">
